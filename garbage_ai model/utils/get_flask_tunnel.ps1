...
$proc = Start-Process ssh -ArgumentList "-o StrictHostKeyChecking=no -p 443 -R0:localhost:5000 free@a.pinggy.io" -RedirectStandardOutput $outFile -RedirectStandardError $errFile -PassThru -NoNewWindow
